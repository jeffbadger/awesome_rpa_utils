...
| [reconciliationutils](src/reconciliationutils/README.md) | `ReconciliationAutomation` | Reconciles two JSON datasets or DataTables by business key and reports matches, differences, records missing on one side, duplicate keys and unusable rows, with exact decimal and text comparison and scalar results for routing. |
