...
| [reconciliationutils](src/reconciliationutils/README.md) | `ReconciliationAutomation` | Reconciles two JSON datasets or DataTables by business key and reports matches, differences, records missing on one side, duplicate keys and unusable rows, with exact decimal, text, Boolean and currency-gated money comparison and scalar results for routing. |
